...
- **Fixed Income (25%)**: A diversified fixed income allocation including government bonds, corporate bonds, and inflation-linked securities. This allocation provides income stability and capital preservation, with UK Gilts and global aggregate bonds forming the core defensive position.

- **Alternatives (20%)**: Strategic alternatives including gold for portfolio diversification and inflation hedging, infrastructure for income generation, and cash equivalents for liquidity management. This allocation enhances portfolio resilience while contributing to the income objective.
...
- Mixed-market data handling (US & UK markets)
- Data quality validation and cleaning
- Timezone alignment and forward-filling
...
- Region-based performance comparison (US vs UK)
